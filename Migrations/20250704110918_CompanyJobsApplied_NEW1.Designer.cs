...
namespace QuizManager.Migrations
{
    ...
    [Migration("20250704110918_CompanyJobsApplied_NEW1")]
    partial class CompanyJobsApplied_NEW1
    {
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyJobApplied_CompanyDetails", b =>
                {
                    ...
                    b.HasIndex("CompanysUniqueIDWhereStudentAppliedForCompanyJob")
                        .IsUnique();

                    b.HasIndex("RNGForCompanyJobAppliedAsStudent_HashedAsUniqueID");
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyJobApplied_StudentDetails", b =>
                {
                    ...
                    b.HasIndex("StudentUniqueIDAppliedForCompanyJob")
                        .IsUnique();
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyJobApplied_CompanyDetails", b =>
                {
                    b.HasOne("QuizManager.Models.CompanyJobApplied", "Application")
                        ...
                        .HasForeignKey("QuizManager.Models.CompanyJobApplied_CompanyDetails", "CompanysUniqueIDWhereStudentAppliedForCompanyJob")
                        .HasPrincipalKey("QuizManager.Models.CompanyJobApplied", "CompanysUniqueIDWhereStudentAppliedForCompanyJob")
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyJobApplied_StudentDetails", b =>
                {
                    b.HasOne("QuizManager.Models.CompanyJobApplied", "Application")
                        ...
                        .HasForeignKey("QuizManager.Models.CompanyJobApplied_StudentDetails", "StudentUniqueIDAppliedForCompanyJob")
                        .HasPrincipalKey("QuizManager.Models.CompanyJobApplied", "StudentUniqueIDAppliedForCompanyJob")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
